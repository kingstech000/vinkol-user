...
| 3 | **Montserrat as the brand voice** | Present on every screen since launch; the geometric character reads confident and modern. | Keep for display and headings. A separate text/UI face for body, labels and numerics is permitted **only** under D-02 in the decisions log, because Montserrat lacks tabular figures and gets wide and loose at 13–15pt. |
